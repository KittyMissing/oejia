...
from weixin.helper import smart_str, smart_bytes, smart_text, md5_constructor as md5
...
class WeixinPay(object):
    ...
    def __init__(self, appid, mch_id, *args, **kwargs):
        ...
        self.sub_appid = kwargs.get('sub_appid')
        self.sub_mch_id = kwargs.get('sub_mch_id')
    ...
    def unifiedorder(self, body='', out_trade_no='', total_fee='', openid='',
        ...
        if self.sub_appid:
            params['sub_openid'] = params.pop('openid')
...
def build_pay_sign(app_id, nonce_str, prepay_id, time_stamp, key, signType='MD5'):
    ...
    return md5(sign.encode('utf-8')).hexdigest().upper()
