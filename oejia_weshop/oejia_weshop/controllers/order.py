...
class WxappOrder(http.Controller, BaseController):
    ...
    def create(self, sub_domain, **kwargs):
        ...
        try:
            ...
            order_dict['commitment_date'] = dt_utc(order_dict.get('expected_date'))
            ...
            data = {
                ...
                "data": {
                    "orderInfo": {
                        ...
                        "status": defs.OrderResponseStatus.attrs[order.customer_status],
                        "statusStr": defs.OrderStatus.attrs[order.customer_status],
                        "requested_date": hasattr(order, "commitment_date") and dt_convert(order.commitment_date) or '',
                        "type": 0,
                        "uid": 1,#user.id,
                    ...
                    "goods": [
                        {
                            ...
                            "uom_name": each_goods.product_uom.name,
